...
class PipelineComponent {
  ...
  public:
    ...
    [[nodiscard]] inline SessionIdType get_session_id() const { return m_session_id; }
    ...
    [[nodiscard]] inline bool pre_call_ack_func() {
    ...
    [[nodiscard]] inline bool canbe_closed_by_pipeline() const {
        return !m_is_async_writing && !pipeline_data_cache.has_queued_data();
    }

    [[nodiscard]] inline bool is_write_close_future() const { return m_write_close_future; }
